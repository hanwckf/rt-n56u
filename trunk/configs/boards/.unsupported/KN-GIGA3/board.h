/* ZyXEL Keenetic Giga III (kng_re) */

#define BOARD_PID		"KN-GIGA3"
#define BOARD_NAME		"KN-GIGA3"
#define BOARD_DESC		"ZyXEL Keenetic Giga III Wireless Router"
#define BOARD_VENDOR_NAME	"ZyXEL Communications Corp."
#define BOARD_VENDOR_URL	"https://zyxel.ru/"
#define BOARD_MODEL_URL		"https://zyxel.ru/keenetic-giga-3"
