/* ZyXEL Keenetic Lite III rev.B (kl_rh) */

#define BOARD_PID		"KN-LITE3B"
#define BOARD_NAME		"KN-LITE3B"
#define BOARD_DESC		"ZyXEL Keenetic Lite III rev.B Wireless Router"
...
#define BOARD_GPIO_BTN_ROUTER	3
