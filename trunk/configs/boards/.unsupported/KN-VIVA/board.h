/* ZyXEL Keenetic Viva (kng_rc) */

#define BOARD_PID		"KN-VIVA"
#define BOARD_NAME		"KN-VIVA"
#define BOARD_DESC		"ZyXEL Keenetic Viva Wireless Router"
#define BOARD_VENDOR_NAME	"ZyXEL Communications Corp."
#define BOARD_VENDOR_URL	"https://zyxel.ru/"
#define BOARD_MODEL_URL		"https://zyxel.ru/keenetic-viva"
...
#define BOARD_GPIO_LED_SW2G	11	/* soft-blink led */
