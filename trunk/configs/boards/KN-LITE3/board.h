/* ZyXEL Keenetic Lite III (kl_rf) */

#define BOARD_PID		"KN-LITE3"
#define BOARD_NAME		"KN-LITE3"
#define BOARD_DESC		"ZyXEL Keenetic Lite III Wireless Router"
#define BOARD_VENDOR_NAME	"ZyXEL Communications Corp."
#define BOARD_VENDOR_URL	"https://zyxel.ru/"
#define BOARD_MODEL_URL		"https://zyxel.ru/keenetic-lite-3"
#define BOARD_BOOT_TIME		20
#define BOARD_FLASH_TIME	90
#define BOARD_GPIO_BTN_RESET	1
#define BOARD_GPIO_BTN_WPS	2
#define BOARD_GPIO_BTN_ROUTER	17
