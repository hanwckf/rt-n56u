...
REG_PAIR   RT3883_RFRegTable[] = {
	...
	{RF_R38, 0x89},
	//{RF_R39, 0x23},
	{RF_R39, 0x63},	// Gary Anwyl, Fix the phase of the TX and RX was changing when they were stopped and started
	{RF_R40, 0x00},
	{RF_R41, 0x00},
	{RF_R42, 0x00},
	{RF_R43, 0x00},
	...
	{RF_R48, 0x00},
	//{RF_R49, 0x8A},
	{RF_R49, 0xAA},	// Gary Anwyl, Fix the phase of the TX and RX was changing when they were stopped and started
	{RF_R50, 0x86},
	{RF_R51, 0x51},
	{RF_R52, 0x05},
	{RF_R53, 0x76},
	...
	IN	PRTMP_ADAPTER	pAd)
{
	...
	RT28xx_EEPROM_READ16(pAd, EEPROM_TXPOWER_BYRATE_40MHZ_OFDM_2_4G, value); /* EEPROM 150h */
	D0 = value & 0xF; /* Reserved */
	D1 = (value >> 4) & 0xF; /* Reserved */
	D2 = (value >> 8) & 0xF; /* 6M/9M */
	D3 = (value >> 12) & 0xF; /* 12M/18M */
	value = (D3 << 12) | (D3 << 8) | (D2 << 4) | D2; /* bit 15:8 -> 12M/18M; bit 7:0 -> 6M/9M */

	pAd->Tx40MPwrCfgGBand[0] = (value << 16) & 0xffff6666; /* bit 15:0 is reserved, set to default value */

	/* 5G @20M 6M/9M/12M/18M */
	RT28xx_EEPROM_READ16(pAd, EEPROM_TXPOWER_BYRATE_20MHZ_OFDM_5G, value); /* EEPROM 160h */
	D0 = value & 0xF; /* Reserved */
	D1 = (value >> 4) & 0xF; /* Reserved */
	D2 = (value >> 8) & 0xF; /* 6M/9M */
	D3 = (value >> 12) & 0xF; /* 12M/18M */
	...
	pAd->Tx20MPwrCfgABand[0] = (value << 16) & 0xffff6666; /* bit 15:0 is reserved, set to default value */

	/* 5G @40M 6M/9M/12M/18M */
	RT28xx_EEPROM_READ16(pAd, EEPROM_TXPOWER_BYRATE_40MHZ_OFDM_5G, value); /* EEPROM 170h */
	D0 = value & 0xF; /* Reserved */	
	D1 = (value >> 4) & 0xF; /* Reserved */
	D2 = (value >> 8) & 0xF; /* 6M/9M */
	D3 = (value >> 12) & 0xF; /* 12M/18M */
	...
	pAd->Tx40MPwrCfgABand[0] = (value << 16) & 0xffff6666; /* bit 15:0 is reserved, set to default value */
	...
	RT28xx_EEPROM_READ16(pAd, EEPROM_TXPOWER_BYRATE_CCK_OFDM + 3, value);		
