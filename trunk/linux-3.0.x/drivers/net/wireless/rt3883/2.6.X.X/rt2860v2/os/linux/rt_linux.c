...
========================================================================
*/
inline VOID RtmpOsPktProtocolAssign(IN PNDIS_PACKET pNetPkt) {
...
inline VOID RtmpOsPktNatMagicTag(IN PNDIS_PACKET pNetPkt) {
#ifdef RTMP_RBUS_SUPPORT
...
inline VOID RtmpOsPktNatNone(IN PNDIS_PACKET pNetPkt) {
#ifdef RTMP_RBUS_SUPPORT
#if defined(CONFIG_RA_NAT_NONE)
#if defined (CONFIG_RA_HW_NAT)  || defined (CONFIG_RA_HW_NAT_MODULE)
