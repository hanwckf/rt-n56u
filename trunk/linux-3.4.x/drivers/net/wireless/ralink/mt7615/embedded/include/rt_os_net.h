...
#ifdef FWDL_IN_PROBE
#define RTMP_DRIVER_FWDL_IN_PROBE_PREPARE(__pAd) \
	RTMP_COM_IoctlHandle(__pAd, NULL, CMD_RTPRIV_IOCTL_FWDL_IN_PROBE_PREPARE, 0, NULL,0)

#define RTMP_DRIVER_FWDL_IN_PROBE_EXIT(__pAd) \
	RTMP_COM_IoctlHandle(__pAd, NULL, CMD_RTPRIV_IOCTL_FWDL_IN_PROBE_EXIT, 0, NULL,0)

#define RTMP_DRIVER_FWDL_IN_PROBE_SET_FLAG(__pAd) \
	RTMP_COM_IoctlHandle(__pAd, NULL, CMD_RTPRIV_IOCTL_FWDL_IN_PROBE_SET_FLAG, 0, NULL,0)

#define RTMP_DRIVER_FWDL_IN_PROBE_CLEAR_FLAG(__pAd) \
	RTMP_COM_IoctlHandle(__pAd, NULL, CMD_RTPRIV_IOCTL_FWDL_IN_PROBE_CLEAR_FLAG, 0, NULL,0)

#define RTMP_DRIVER_FWDL_IN_PROBE_CAL_WAIT_AND_CLEAR(__pAd) \
	RTMP_COM_IoctlHandle(__pAd, NULL, CMD_RTPRIV_IOCTL_FWDL_IN_PROBE_CAL_WAIT_AND_CLEAR, 0, NULL,0)
#endif
