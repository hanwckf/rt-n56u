...
static VOID ExtEventFw2apccciMsgHandler(RTMP_ADAPTER *pAd, UINT8 *Data, UINT32 Length)
{
	struct _EXT_EVENT_FW2APCCCI_T *fw2apccci_msg;

	fw2apccci_msg = (struct _EXT_EVENT_FW2APCCCI_T *)Data;
	fw2apccci_msg->len = Length;
	call_wifi_md_coex_notifier(FW_DRIVER_APCCCI, (void *)fw2apccci_msg);
}
