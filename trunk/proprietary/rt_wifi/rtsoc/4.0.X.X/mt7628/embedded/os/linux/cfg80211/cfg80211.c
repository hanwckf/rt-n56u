...
#endif /* LINUX_VERSION_CODE: 3.6.0 */
{
	...
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("80211> n_ssids == 0 or null ssids Wildcard SSID.\n"));
