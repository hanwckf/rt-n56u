...
enum{
	...
	RESTART_QOS		= 0x00000020,
	RESTART_IPV6		= 0x00000080,

	RESTART_TIME		= 0x00000100,
	RESTART_NTPC		= 0x00000200,
	RESTART_SYSLOG		= 0x00000400,
	RESTART_RSTATS		= 0x00000800,

	RESTART_TERMINAL	= 0x00001000,
	RESTART_VPNSRV		= 0x00002000,
	RESTART_SYSCTL		= 0x00004000,
	...
	RESTART_TORRENT		= 0x00100000,
	RESTART_DMS		= 0x00200000,
	RESTART_ITUNES		= 0x00400000,
	RESTART_WEBCAM		= 0x00800000,
	...
	RESTART_LAN_DHCPD	= 0x20000000,
	RESTART_WAN		= 0x40000000,
...
#define ITVL_RESTART_LAN_DHCPD		1
