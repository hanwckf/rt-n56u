...
#include "common.h"
	...
	struct variable variables_LANHostConfig[] = {
			...
			{"ovpnsvr.ca.crt", "File", NULL, EVM_RESTART_VPNSVR|EVM_BLOCK_UNSAFE},
			{"ovpnsvr.server.conf", "File", NULL, EVM_RESTART_VPNSVR},
			{"ovpnsvr.server.crt", "File", NULL, EVM_RESTART_VPNSVR|EVM_BLOCK_UNSAFE},
			{"ovpnsvr.server.key", "File", NULL, EVM_RESTART_VPNSVR|EVM_BLOCK_UNSAFE},
			{"ovpnsvr.dh1024.pem", "File", NULL, EVM_RESTART_VPNSVR|EVM_BLOCK_UNSAFE},
			{"ovpnsvr.ta.key", "File", NULL, EVM_RESTART_VPNSVR|EVM_BLOCK_UNSAFE},
