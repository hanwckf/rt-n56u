...
#include "common.h"
	...
	struct variable variables_General[] = {
			...
			{"scripts.start_script.sh", "File", NULL, FALSE},
	...
	struct variable variables_Storage[] = {
			...
			{"st_samba_lmb", "", NULL, EVM_RESTART_WINS},
			{"st_samba_workgroup", "", NULL, EVM_RESTART_WINS},
			{"computer_name", "", NULL, EVM_RESTART_DHCPD|EVM_RESTART_FTPD|EVM_RESTART_SMBD|EVM_RESTART_DMS|EVM_RESTART_ITUNES},
	...
	struct variable variables_RouterConfig[] = {
			...
			{"mr_ttl_fix", "", NULL, EVM_RESTART_FIREWALL},
	...
	struct variable variables_LANHostConfig[] = {
			...
			{"dhcp_enable_x", "", NULL, EVM_RESTART_DHCPD},
			...
			{"dhcp_dns1_x", "", NULL, EVM_RESTART_DHCPD},
			{"dhcp_dns2_x", "", NULL, EVM_RESTART_DHCPD},
			...
			{"httpssl.ca.crt", "File", NULL, EVM_RESTART_HTTPD},
			{"httpssl.server.crt", "File", NULL, EVM_RESTART_HTTPD},
			{"httpssl.server.key", "File", NULL, EVM_RESTART_HTTPD},
			{"httpssl.dh1024.pem", "File", NULL, EVM_RESTART_HTTPD},
#endif
			{"telnetd", "", NULL, EVM_RESTART_TELNETD},
			{"sshd_enable", "", NULL, EVM_RESTART_SSHD},
			{"wins_enable", "", NULL, EVM_RESTART_WINS},
			{"lltd_enable", "", NULL, EVM_RESTART_LLTD},
			{"adsc_enable", "", NULL, EVM_RESTART_ADSC},
			{"scripts.authorized_keys", "File", NULL, EVM_RESTART_SSHD},
			...
			{"vpns_cast", "", NULL, EVM_RESTART_VPNSVR},
			{"vpns_auth", "", NULL, EVM_RESTART_VPNSVR},
			{"vpns_mppe", "", NULL, EVM_RESTART_VPNSVR},
			{"vpns_mtu", "", NULL, EVM_RESTART_VPNSVR},
			{"vpns_mru", "", NULL, EVM_RESTART_VPNSVR},
			...
			{"vpns_ov_mdig", "", NULL, EVM_RESTART_VPNSVR},
			{"vpns_ov_ciph", "", NULL, EVM_RESTART_VPNSVR},
			{"vpns_ov_clzo", "", NULL, EVM_RESTART_VPNSVR},
			{"vpns_ov_atls", "", NULL, EVM_RESTART_VPNSVR},
			{"vpns_ov_rdgw", "", NULL, EVM_RESTART_VPNSVR},
			...
			{"ovpnsvr.ca.crt", "File", NULL, EVM_RESTART_VPNSVR},
			{"ovpnsvr.server.conf", "File", NULL, EVM_RESTART_VPNSVR},
			{"ovpnsvr.server.crt", "File", NULL, EVM_RESTART_VPNSVR},
			{"ovpnsvr.server.key", "File", NULL, EVM_RESTART_VPNSVR},
			{"ovpnsvr.dh1024.pem", "File", NULL, EVM_RESTART_VPNSVR},
			{"ovpnsvr.ta.key", "File", NULL, EVM_RESTART_VPNSVR},
	...
	struct variable variables_WLANConfig11a[] = {
			...
			{"wl_mbssid_isolate", "", NULL, EVM_RESTART_WIFI5},
			{"wl_rate", "", NULL, EVM_RESTART_WIFI5},
			{"wl_IgmpSnEnable", "", NULL, EVM_RESTART_WIFI5},
			{"wl_mcastrate", "", NULL, EVM_RESTART_WIFI5},
	...
	struct variable variables_WLANConfig11b[] = {
			...
			{"rt_mbssid_isolate", "", NULL, EVM_RESTART_WIFI2},
			{"rt_closed", "", NULL, EVM_RESTART_WIFI2},
			{"rt_IgmpSnEnable", "", NULL, EVM_RESTART_WIFI2},
			{"rt_mcastrate", "", NULL, EVM_RESTART_WIFI2},
			...
			{"rt_lazywds", "", NULL, EVM_RESTART_WIFI2},
	...
	struct evDesc events_desc[] = {
		...
		{EVM_RESTART_WINS,		EVT_RESTART_WINS,		RCN_RESTART_WINS,	EVM_RESTART_DHCPD|EVM_RESTART_SMBD},
#endif
...
#endif
#if defined(APP_SMBD)
		{EVM_RESTART_SMBD,		EVT_RESTART_SMBD,		RCN_RESTART_SMBD,	0},
#endif
#if defined(APP_NFSD)
