 ...
 */
	...
	struct variable variables_LANHostConfig[] = {
			...
			{"vpns_ov_vnet", "", NULL, RESTART_VPNSVR},
			{"vpns_ov_mask", "", NULL, RESTART_VPNSVR},
			{"vpns_ov_rdgw", "", NULL, RESTART_VPNSVR},
			{"ovpnsvr.ca.crt", "", NULL, RESTART_VPNSVR},
			{"ovpnsvr.server.conf", "", NULL, RESTART_VPNSVR},
			{"ovpnsvr.server.crt", "", NULL, RESTART_VPNSVR},
			{"ovpnsvr.server.key", "", NULL, RESTART_VPNSVR},
			{"ovpnsvr.dh1024.pem", "", NULL, RESTART_VPNSVR},
			{"ovpnsvr.ta.key", "", NULL, RESTART_VPNSVR},
			{"ovpncli.ca.crt", "", NULL, RESTART_VPNCLI},
			{"ovpncli.client.conf", "", NULL, RESTART_VPNCLI},
