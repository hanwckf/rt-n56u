...
#include "httpd.h"
	...
	struct variable variables_General[] = {
			...
			{"modem_country", "", NULL, RESTART_MODEM},
			{"modem_isp", "", NULL, RESTART_MODEM},
			{"modem_apn", "", NULL, RESTART_MODEM},
			{"modem_dialnum", "", NULL, RESTART_MODEM},
			{"modem_user", "", NULL, RESTART_MODEM},
			{"modem_pass", "", NULL, RESTART_MODEM},
			{"modem_pin", "", NULL, RESTART_MODEM},
			{"modem_dnsa", "", NULL, RESTART_MODEM},
			{"modem_node", "", NULL, RESTART_MODEM},
			{"modem_nets", "", NULL, RESTART_MODEM},
			{"modem_cmd", "", NULL, RESTART_MODEM},
			{"modem_mtu", "", NULL, RESTART_MODEM},
			{"modem_zcd", "", NULL, FALSE},
			{"di_poll_mode", "", NULL, RESTART_DI},
			...
			{"di_addr3", "", NULL, RESTART_DI},
			{"di_addr4", "", NULL, RESTART_DI},
			{"di_addr5", "", NULL, RESTART_DI},
			{"di_port0", "", NULL, RESTART_DI},
			{"di_port1", "", NULL, RESTART_DI},
			{"di_port2", "", NULL, RESTART_DI},
			{"di_port3", "", NULL, RESTART_DI},
			{"di_port4", "", NULL, RESTART_DI},
			{"di_port5", "", NULL, RESTART_DI},
			{"ez_action_short", "", NULL, FALSE},
			{"ez_action_long", "", NULL, FALSE},
			{"front_led_all", "", NULL, RESTART_TWEAKS},
			{"front_led_wan", "", NULL, RESTART_TWEAKS},
			{"front_led_lan", "", NULL, RESTART_TWEAKS},
			{"front_led_usb", "", NULL, RESTART_TWEAKS},
			{"front_led_wif", "", NULL, RESTART_TWEAKS},
			{"front_led_pwr", "", NULL, RESTART_TWEAKS},
			{"watchdog_cpu", "", NULL, RESTART_TWEAKS},
	...
	struct variable variables_PPPConnection[] = {
			...
			{"wan_pppoe_man", "", NULL, RESTART_WAN},
	...
	struct variable variables_FirewallConfig[] = {
			...
			{"fw_syn_cook", "", NULL, RESTART_SYSCTL},
			{"fw_mac_drop", "", NULL, RESTART_FIREWALL},
			{"nf_nat_loop", "", NULL, RESTART_FIREWALL},
			{"nf_nat_type", "", NULL, RESTART_SYSCTL},
			{"nf_max_conn", "", NULL, RESTART_SYSCTL},
	...
	struct variable variables_LANHostConfig[] = {
			...
			{"vpns_ov_mdig", "", NULL, RESTART_VPNSVR},
			{"vpns_ov_ciph", "", NULL, RESTART_VPNSVR},
			{"vpns_ov_clzo", "", NULL, RESTART_VPNSVR},
			...
			{"vpnc_ov_mdig", "", NULL, RESTART_VPNCLI},
			{"vpnc_ov_ciph", "", NULL, RESTART_VPNCLI},
			{"vpnc_ov_clzo", "", NULL, RESTART_VPNCLI},
