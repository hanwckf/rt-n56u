 ...
 */
	...
	struct variable variables_General[] = {
			...
			{"Dev3G", "", NULL, RESTART_WAN},
			{"modem_enable", "", NULL, RESTART_WAN},
	...
	struct variable variables_Storage[] = {
			...
			{"dlna_source", "", NULL, RESTART_DMS},
			{"dlna_rescan", "", NULL, FALSE},
	...
	struct variable variables_Layer3Forwarding[] = {
			...
			{"vlan_filter", "", NULL, RESTART_SWITCH_VLAN},
			{"vlan_vid_cpu", "", NULL, RESTART_SWITCH_VLAN},
			{"vlan_pri_cpu", "", NULL, RESTART_SWITCH_VLAN},
	...
	struct variable variables_LANHostConfig[] = {
			...
			{"lan_domain", "", NULL, RESTART_LAN_DHCPD},
			{"udpxy_enable_x", "", NULL, RESTART_WAN},
			{"dhcp_enable_x", "", NULL, RESTART_LAN_DHCPD},
			{"dhcp_start", "", NULL, RESTART_LAN_DHCPD},
			{"dhcp_end", "", NULL, RESTART_LAN_DHCPD},
			{"dhcp_lease", "", NULL, RESTART_LAN_DHCPD},
			{"dhcp_gateway_x", "", NULL, RESTART_LAN_DHCPD},
			{"dhcp_dns1_x", "", NULL, RESTART_LAN_DHCPD},
			{"dhcp_dns2_x", "", NULL, RESTART_LAN_DHCPD},
			{"dhcp_dns3_x", "", NULL, RESTART_LAN_DHCPD},
			{"dhcp_wins_x", "", NULL, RESTART_LAN_DHCPD},
			...
			{"rstats_path", "", NULL, RESTART_RSTATS},
			{"rstats_enable", "", NULL, RESTART_RSTATS},
			{"rstats_stime", "", NULL, RESTART_RSTATS},
			{"rstats_sshut", "", NULL, RESTART_RSTATS},
			{"rstats_bak", "", NULL, RESTART_RSTATS},
			{"rstats_new", "", NULL, RESTART_RSTATS},
			...
			{"ManualDHCPList", "Group", ARGV((char*)variables_LANHostConfig_ManualDHCPList, "8", "55", "dhcp_staticnum_x"), RESTART_LAN_DHCPD},
	...
	struct variable variables_WLANConfig11a[] = {
			...
			{"wl_afterburner", "", NULL, RESTART_WIFI},
			{"wl_nbw_cap", "", NULL, RESTART_WIFI},
			{"wl_txstreams", "", NULL, RESTART_WIFI},
			{"wl_rxstreams", "", NULL, RESTART_WIFI},
			{"wl_closed", "", NULL, RESTART_WIFI},
			{"wl_ap_isolate", "", NULL, RESTART_WIFI},
			{"wl_mbssid_isolate", "", NULL, RESTART_WIFI},
			{"wl_radarthrs", "", NULL, RESTART_WIFI},
			...
			{"wl_frameburst", "", NULL, RESTART_WIFI},
			...
			{"wl_preauth", "", NULL, RESTART_WIFI},
			{"wl_net_reauth", "", NULL, RESTART_WIFI},
