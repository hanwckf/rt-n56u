...
struct bkrp_exported_RSA_key_pair {
	...
	DATA_BLOB coefficient;/* [flag(LIBNDR_FLAG_REMAINING),subcontext_size(128),subcontext(0)] */
	DATA_BLOB private_exponent;/* [flag(LIBNDR_FLAG_REMAINING),subcontext_size(256),subcontext(0)] */
	DATA_BLOB cert;/* [subcontext(0),subcontext_size(certificate_len),flag(LIBNDR_FLAG_REMAINING)] */
};
