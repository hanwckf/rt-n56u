...
struct drsuapi_DsReplicaSyncRequest1 {
	...
	const char * source_dsa_dns;/* [flag(LIBNDR_FLAG_STR_ASCII|LIBNDR_FLAG_STR_NULLTERM),unique] */
	uint32_t options;
};
...
struct drsuapi_DsGetNCChangesMSZIPCtr1 {
	...
	struct drsuapi_DsGetNCChangesCtr1TS *ts;/* [subcontext_size(compressed_length),compression(NDR_COMPRESSION_MSZIP,compressed_length,decompressed_length),unique,subcontext(4)] */
}/* [nopush] */;

struct drsuapi_DsGetNCChangesMSZIPCtr6 {
	uint32_t decompressed_length;
	uint32_t compressed_length;
	struct drsuapi_DsGetNCChangesCtr6TS *ts;/* [subcontext_size(compressed_length),subcontext(4),unique,compression(NDR_COMPRESSION_MSZIP,compressed_length,decompressed_length)] */
}/* [nopush] */;

struct drsuapi_DsGetNCChangesXPRESSCtr1 {
	uint32_t decompressed_length;
	uint32_t compressed_length;
	struct drsuapi_DsGetNCChangesCtr1TS *ts;/* [subcontext_size(compressed_length),compression(NDR_COMPRESSION_XPRESS,compressed_length,decompressed_length),unique,subcontext(4)] */
}/* [nopush] */;

struct drsuapi_DsGetNCChangesXPRESSCtr6 {
	uint32_t decompressed_length;
	uint32_t compressed_length;
	struct drsuapi_DsGetNCChangesCtr6TS *ts;/* [subcontext_size(compressed_length),compression(NDR_COMPRESSION_XPRESS,compressed_length,decompressed_length),unique,subcontext(4)] */
}/* [nopush] */;
