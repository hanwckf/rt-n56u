...
struct eventlog6_EvtRpcClearLog {
	struct {
		struct policy_handle *control;/* [ref] */
		const char *channelPath;/* [range(0,MAX_RPC_CHANNEL_NAME_LENGTH),ref,charset(UTF16)] */
...
struct eventlog6_EvtRpcGetChannelList {
	...
	struct {
		...
		const char ***channelPaths;/* [range(0,MAX_RPC_CHANNEL_COUNT),size_is(,*numChannelPaths),ref,charset(UTF16)] */
		WERROR result;
	} out;
...
struct eventlog6_EvtRpcGetPublisherListForChannel {
	...
	struct {
		uint32_t *numPublisherIds;/* [ref] */
		const char ***publisherIds;/* [range(0,MAX_RPC_PUBLISHER_COUNT),size_is(,*numPublisherIds),ref,charset(UTF16)] */
		WERROR result;
	} out;
