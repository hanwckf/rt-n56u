...
struct tevent_req *dcerpc_eventlog6_EvtRpcClearLog_send(TALLOC_CTX *mem_ctx,
							...
							const char *_channelPath /* [in] [range(0,MAX_RPC_CHANNEL_NAME_LENGTH),ref,charset(UTF16)] */,
...
struct tevent_req *dcerpc_eventlog6_EvtRpcGetChannelList_send(TALLOC_CTX *mem_ctx,
							      ...
							      const char ***_channelPaths /* [out] [range(0,MAX_RPC_CHANNEL_COUNT),size_is(,*numChannelPaths),ref,charset(UTF16)] */);
...
struct tevent_req *dcerpc_eventlog6_EvtRpcGetPublisherListForChannel_send(TALLOC_CTX *mem_ctx,
									  ...
									  uint32_t _flags /* [in]  */,
									  uint32_t *_numPublisherIds /* [out] [ref] */,
									  const char ***_publisherIds /* [out] [range(0,MAX_RPC_PUBLISHER_COUNT),size_is(,*numPublisherIds),ref,charset(UTF16)] */);
