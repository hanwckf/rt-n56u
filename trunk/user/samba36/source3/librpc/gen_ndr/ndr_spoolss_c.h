...
struct tevent_req *dcerpc_spoolss_EnumPrinters_send(TALLOC_CTX *mem_ctx,
						    ...
						    union spoolss_PrinterInfo **_info /* [out] [switch_is(level),ref,size_is(,*count)] */,
...
struct tevent_req *dcerpc_spoolss_GetJob_send(TALLOC_CTX *mem_ctx,
					      ...
					      DATA_BLOB *_buffer /* [in] [unique] */,
					      uint32_t _offered /* [in]  */,
					      union spoolss_JobInfo *_info /* [out] [switch_is(level),unique,subcontext(4),subcontext_size(offered)] */,
					      uint32_t *_needed /* [out] [ref] */);
...
struct tevent_req *dcerpc_spoolss_GetPrinterDriver_send(TALLOC_CTX *mem_ctx,
							...
							DATA_BLOB *_buffer /* [in] [unique] */,
							uint32_t _offered /* [in]  */,
							union spoolss_DriverInfo *_info /* [out] [subcontext_size(offered),subcontext(4),unique,switch_is(level)] */,
							uint32_t *_needed /* [out] [ref] */);
...
struct tevent_req *dcerpc_spoolss_GetPrinterDriverDirectory_send(TALLOC_CTX *mem_ctx,
								 ...
								 DATA_BLOB *_buffer /* [in] [unique] */,
								 uint32_t _offered /* [in]  */,
								 union spoolss_DriverDirectoryInfo *_info /* [out] [subcontext_size(offered),subcontext(4),switch_is(level),unique] */,
								 uint32_t *_needed /* [out] [ref] */);
...
struct tevent_req *dcerpc_spoolss_EnumPrinterKey_send(TALLOC_CTX *mem_ctx,
						      ...
						      union spoolss_KeyNames *_key_buffer /* [out] [subcontext_size(*_ndr_size*2),subcontext(0),ref,switch_is(*_ndr_size)] */,
						      uint32_t _offered /* [in]  */,
						      uint32_t *_needed /* [out] [ref] */);
