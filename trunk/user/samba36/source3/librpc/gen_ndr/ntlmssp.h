...
struct NEGOTIATE_MESSAGE {
	...
	const char * DomainName;/* [subcontext(0),flag(ndr_ntlmssp_negotiated_string_flags(NTLMSSP_NEGOTIATE_OEM)),relative,subcontext_size(DomainNameLen)] */
	uint16_t WorkstationLen;/* [value(Workstation?strlen(Workstation):0)] */
	uint16_t WorkstationMaxLen;/* [value(WorkstationLen)] */
	const char * Workstation;/* [relative,flag(ndr_ntlmssp_negotiated_string_flags(NTLMSSP_NEGOTIATE_OEM)),subcontext_size(WorkstationLen),subcontext(0)] */
...
struct AV_PAIR_LIST {
	uint32_t count;
	struct AV_PAIR *pair;
}/* [flag(LIBNDR_FLAG_NOALIGN),nopush,nopull,gensize] */;
...
struct CHALLENGE_MESSAGE {
	...
	const char * TargetName;/* [subcontext(0),subcontext_size(TargetNameLen),flag(ndr_ntlmssp_negotiated_string_flags(r->NegotiateFlags)),relative] */
	uint32_t NegotiateFlags;
...
struct AUTHENTICATE_MESSAGE {
	...
	union ntlmssp_LM_RESPONSE *LmChallengeResponse;/* [switch_is(LmChallengeResponseLen),subcontext(0),subcontext_size(LmChallengeResponseLen),relative] */
	...
	uint16_t WorkstationMaxLen;/* [value(WorkstationLen)] */
	const char * Workstation;/* [subcontext_size(WorkstationLen),relative,flag(ndr_ntlmssp_negotiated_string_flags(r->NegotiateFlags)),subcontext(0)] */
