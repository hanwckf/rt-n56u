...
}/* [flag(LIBNDR_FLAG_RELATIVE_REVERSE),public,nodiscriminant,relative_base,gensize] */;
...
}/* [gensize,relative_base,flag(LIBNDR_FLAG_RELATIVE_REVERSE),public,nodiscriminant] */;
...
}/* [public,nodiscriminant,flag(LIBNDR_FLAG_RELATIVE_REVERSE),relative_base,gensize] */;
...
}/* [relative_base,gensize,flag(LIBNDR_FLAG_RELATIVE_REVERSE),nodiscriminant,public] */;
...
}/* [nodiscriminant,public,flag(LIBNDR_FLAG_RELATIVE_REVERSE),relative_base] */;
...
struct spoolss_EnumPrinters {
	...
	struct {
		uint32_t *count;/* [ref] */
		union spoolss_PrinterInfo **info;/* [switch_is(level),ref,size_is(,*count)] */
		uint32_t *needed;/* [ref] */
		WERROR result;
	} out;
...
struct spoolss_GetJob {
	...
	struct {
		union spoolss_JobInfo *info;/* [switch_is(level),unique,subcontext(4),subcontext_size(offered)] */
		uint32_t *needed;/* [ref] */
		WERROR result;
	} out;
...
struct spoolss_GetPrinterDriver {
	...
	struct {
		union spoolss_DriverInfo *info;/* [subcontext_size(offered),subcontext(4),unique,switch_is(level)] */
		uint32_t *needed;/* [ref] */
		WERROR result;
	} out;
...
struct spoolss_GetPrinterDriverDirectory {
	...
	struct {
		union spoolss_DriverDirectoryInfo *info;/* [subcontext_size(offered),subcontext(4),switch_is(level),unique] */
		uint32_t *needed;/* [ref] */
		WERROR result;
	} out;
...
struct spoolss_EnumPrinterKey {
	...
	struct {
		...
		union spoolss_KeyNames *key_buffer;/* [subcontext_size(*_ndr_size*2),subcontext(0),ref,switch_is(*_ndr_size)] */
		uint32_t *needed;/* [ref] */
		WERROR result;
	} out;
