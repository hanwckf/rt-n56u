...
struct nvram_pair router_defaults[] = {
	...
	{ "minieap_password", "" },
	{ "minieap_nic", "" },
	{ "minieap_module", "printer" },
	{ "minieap_daemonize", "0" },
	{ "minieap_if-impl", "sockraw" },
	{ "minieap_max-fail", "3" },
	{ "minieap_max-retries", "3" },
	{ "minieap_no-auto-reauth", "0" },
	{ "minieap_wait-after-fail", "30" },
	{ "minieap_stage-timeout", "5" },
	{ "minieap_auth-round", "1" },
	{ "minieap_pid-file", "/var/run/minieap.pid" },
	{ "minieap_log-file", "/var/log/minieap.log" },
	{ "minieap_heartbeat", "60" },
	{ "minieap_eap-bcast-addr", "0" },
	{ "minieap_dhcp-type", "0" },
	{ "minieap_service", "internet" },
	{ "minieap_version-str", "RG-SU For Linux V1.30" },
	{ "minieap_dhcpscript", "" },
	{ "minieap_fake-serial", "" },
	{ "minieap_max-dhcp-count", "3" },
#endif
