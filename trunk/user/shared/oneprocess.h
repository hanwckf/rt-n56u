...
/* vsf_one_process_path_lookup()
 * PURPOSE
 * NASoC virtual path 2 real path conversion one for process model.
 * PARAMETERS
 * p_path_str   - the path to convert.
 * access_kind  - requested access
 */
void vsf_one_process_path_lookup(struct mystr* p_path_str, int access_kind);
