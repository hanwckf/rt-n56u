...
function showACLList(){
	...
	if(ACLList.length == 0) {
		...
		for(var i = 0; i < ACLList.length; i++){
		    ...
		    code +='<td width="20%"><input type="checkbox" name="ACLList_s" value="' + i + '" onClick="changeBgColor(this,' + i + ');" id="check' + i + '"></td>';
		    code +='</tr>';
		}
		
		code += '<tfoot><tr>';
		code += '<td colspan="2">&nbsp;</td>'
		code += '<td><input class="button" type="submit" onclick="return markGroupACL(this, 32, \' Del \');" name="ACLList" value="<#CTL_del#>"></td>';
		code += '</tr></tfoot>'
	}
...
<input type="hidden" name="wl_macnum_x_0" value="<% nvram_get_x("", "wl_macnum_x"); %>" readonly="1" />
		...
		<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3"  class="FormTable">
			<tr>
				...
				<td>
					...
					<option value="disabled" <% nvram_match_x("DeviceSecurity11a","wl_macmode", "disable","selected"); %>><#CTL_Disabled#></option>
	...
	<tr>
	  <td bgcolor="#FFFFFF">
                ...
                <tr>
                    <td align="center">
                        <input type="text" class="input" size="25" maxlength="12" name="wl_maclist_x_0" onkeypress="return is_hwaddr()" />
                    </td>
                    <td align="center">
                        <input type="text" class="input" size="32" maxlength="32" name="wl_macdesc_x_0" onkeypress="return is_string(this)" />
                    </td>
                    <td align="center">
                        <input class="button" type="submit" onclick="return markGroupACL(this, 32, ' Add ');" name="ACLList2" value="<#CTL_add#>"/>
                    </td>
                </tr>
                </table>
                ...
                <tr align="right">
                    <td colspan="2">
                        <input type="button" class="button2" value="<#GO_2G#>" onclick="location.href='Advanced_ACL2g_Content.asp';">    
