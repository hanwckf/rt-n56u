	  ...
	  <td bgcolor="#FFFFFF">
		<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3"  class="FormTable" id="WAdvTable">
			<tr>
			  ...
			  <td>
				<input type="radio" value="1" name="wl_radio_x" class="input" onClick="return change_common_radio(this, 'WLANConfig11a', 'wl_radio_x', '1')" <% nvram_match_x("WLANConfig11a","wl_radio_x", "1", "checked"); %>/><#checkbox_Yes#>
				<input type="radio" value="0" name="wl_radio_x" class="input" onClick="return change_common_radio(this, 'WLANConfig11a', 'wl_radio_x', '0')" <% nvram_match_x("WLANConfig11a","wl_radio_x", "0", "checked"); %>/><#checkbox_No#>
			  </td>
			</tr>
			<tr>
			  <th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 2);"><#WLANConfig11b_x_RadioEnableDate_itemname#></a></th>
			  <td>
				<input type="checkbox" class="input" name="wl_radio_date_x_Mon" onChange="return changeDate();"/><#DAY_Mon#>
				<input type="checkbox" class="input" name="wl_radio_date_x_Tue" onChange="return changeDate();"/><#DAY_Tue#>
				<input type="checkbox" class="input" name="wl_radio_date_x_Wed" onChange="return changeDate();"/><#DAY_Wed#>
				<input type="checkbox" class="input" name="wl_radio_date_x_Thu" onChange="return changeDate();"/><#DAY_Thu#>
				<input type="checkbox" class="input" name="wl_radio_date_x_Fri" onChange="return changeDate();"/><#DAY_Fri#>
			  </td>
			</tr>
			<tr>
			  <th><a class="hintstyle"  href="javascript:void(0);" onClick="openHint(3, 3);"><#WLANConfig11b_x_RadioEnableTime_itemname#></a></th>
			  <td>
				<input type="text" maxlength="2" class="input" size="2" style="width: 20px;" name="wl_radio_time_x_starthour" onKeyPress="return is_number(this)"/>:
				<input type="text" maxlength="2" class="input" size="2" style="width: 20px;" name="wl_radio_time_x_startmin" onKeyPress="return is_number(this)"/>-
				<input type="text" maxlength="2" class="input" size="2" style="width: 20px;" name="wl_radio_time_x_endhour" onKeyPress="return is_number(this)"/>:
				<input type="text" maxlength="2" class="input" size="2" style="width: 20px;" name="wl_radio_time_x_endmin" onKeyPress="return is_number(this)"/>
			  </td>
			</tr>
			<tr>
			  <th><#WLANConfig11b_x_RadioEnableDate_itemname2#></th>
			  <td>
				<input type="checkbox" class="input" name="wl_radio_date_x_Sat" onChange="return changeDate();"/><#DAY_Sat#>
				<input type="checkbox" class="input" name="wl_radio_date_x_Sun" onChange="return changeDate();"/><#DAY_Sun#>
			  </td>
			</tr>
			<tr>
			  <th><#WLANConfig11b_x_RadioEnableTime_itemname2#></th>
			  <td>
				<input type="text" maxlength="2" class="input" size="2" style="width: 20px;" name="wl_radio_time2_x_starthour" onKeyPress="return is_number(this)"/>:
				<input type="text" maxlength="2" class="input" size="2" style="width: 20px;" name="wl_radio_time2_x_startmin" onKeyPress="return is_number(this)"/>-
				<input type="text" maxlength="2" class="input" size="2" style="width: 20px;" name="wl_radio_time2_x_endhour" onKeyPress="return is_number(this)"/>:
				<input type="text" maxlength="2" class="input" size="2" style="width: 20px;" name="wl_radio_time2_x_endmin" onKeyPress="return is_number(this)"/>
			  </td>
			</tr>
			<tr>
			  <th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 5);"><#WLANConfig11b_x_IsolateAP_itemname#></a></th>
			  <td>
				<input type="radio" value="1" name="wl_ap_isolate" class="input" <% nvram_match_x("WLANConfig11a","wl_ap_isolate", "1", "checked"); %>/><#checkbox_Yes#>
				<input type="radio" value="0" name="wl_ap_isolate" class="input" <% nvram_match_x("WLANConfig11a","wl_ap_isolate", "0", "checked"); %>/><#checkbox_No#>
			  </td>
			</tr>
			<tr>
			  <th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 5);"><#WIFIGuestIsolate#></a></th>
			  <td>
				<input type="radio" value="1" name="wl_mbssid_isolate" class="input" <% nvram_match_x("WLANConfig11a","wl_mbssid_isolate", "1", "checked"); %>/><#checkbox_Yes#>
				<input type="radio" value="0" name="wl_mbssid_isolate" class="input" <% nvram_match_x("WLANConfig11a","wl_mbssid_isolate", "0", "checked"); %>/><#checkbox_No#>
			  </td>
			</tr>
			<tr>
