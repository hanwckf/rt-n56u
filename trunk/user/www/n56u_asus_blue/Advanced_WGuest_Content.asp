		...
		<tr>
		  <td bgcolor="#FFFFFF">
			...
			<tr id="row_guest_1" style="display:none;">
			  <th><#WIFIGuestDate#></th>
			  <td>
				<input type="checkbox" class="input" name="wl_guest_date_x_Mon" onChange="return changeDate();"/><#DAY_Mon#>
				<input type="checkbox" class="input" name="wl_guest_date_x_Tue" onChange="return changeDate();"/><#DAY_Tue#>
				<input type="checkbox" class="input" name="wl_guest_date_x_Wed" onChange="return changeDate();"/><#DAY_Wed#>
				<input type="checkbox" class="input" name="wl_guest_date_x_Thu" onChange="return changeDate();"/><#DAY_Thu#>
				<input type="checkbox" class="input" name="wl_guest_date_x_Fri" onChange="return changeDate();"/><#DAY_Fri#>
			  </td>
			</tr>
			<tr id="row_guest_2" style="display:none;">
			  <th><#WIFIGuestTime#></th>
			  <td>
				<input type="text" maxlength="2" class="input" size="2" style="width: 20px;" name="wl_guest_time_x_starthour" onKeyPress="return is_number(this)"/>:
				<input type="text" maxlength="2" class="input" size="2" style="width: 20px;" name="wl_guest_time_x_startmin" onKeyPress="return is_number(this)"/>-
				<input type="text" maxlength="2" class="input" size="2" style="width: 20px;" name="wl_guest_time_x_endhour" onKeyPress="return is_number(this)"/>:
				<input type="text" maxlength="2" class="input" size="2" style="width: 20px;" name="wl_guest_time_x_endmin" onKeyPress="return is_number(this)"/>
			  </td>
			</tr>
			<tr id="row_guest_3" style="display:none;">
			  <th><#WIFIGuestDate2#></th>
			  <td>
				<input type="checkbox" class="input" name="wl_guest_date_x_Sat" onChange="return changeDate();"/><#DAY_Sat#>
				<input type="checkbox" class="input" name="wl_guest_date_x_Sun" onChange="return changeDate();"/><#DAY_Sun#>
			  </td>
			</tr>
			<tr id="row_guest_4" style="display:none;">
			  <th><#WIFIGuestTime2#></th>
			  <td>
				<input type="text" maxlength="2" class="input" size="2" style="width: 20px;" name="wl_guest_time2_x_starthour" onKeyPress="return is_number(this)"/>:
				<input type="text" maxlength="2" class="input" size="2" style="width: 20px;" name="wl_guest_time2_x_startmin" onKeyPress="return is_number(this)"/>-
				<input type="text" maxlength="2" class="input" size="2" style="width: 20px;" name="wl_guest_time2_x_endhour" onKeyPress="return is_number(this)"/>:
				<input type="text" maxlength="2" class="input" size="2" style="width: 20px;" name="wl_guest_time2_x_endmin" onKeyPress="return is_number(this)"/>
			  </td>
			</tr>
			...
			<tr align="right">
				<td colspan="2">
					<input type="button" class="button2" value="<#GO_2G#>" onclick="location.href='Advanced_WGuest2g_Content.asp';">
