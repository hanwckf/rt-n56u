		...
		<tr>
		  <td bgcolor="#FFFFFF">
			...
			<tr id="row_guest_1" style="display:none;">
			  <th><#WIFIGuestDate#></th>
			  <td>
				<input type="checkbox" class="input" name="wl_guest_date_x_Sun" onChange="return changeDate();"/>Sun
				<input type="checkbox" class="input" name="wl_guest_date_x_Mon" onChange="return changeDate();"/>Mon
				<input type="checkbox" class="input" name="wl_guest_date_x_Tue" onChange="return changeDate();"/>Tue
				<input type="checkbox" class="input" name="wl_guest_date_x_Wed" onChange="return changeDate();"/>Wed
				<input type="checkbox" class="input" name="wl_guest_date_x_Thu" onChange="return changeDate();"/>Thu
				<input type="checkbox" class="input" name="wl_guest_date_x_Fri" onChange="return changeDate();"/>Fri
				<input type="checkbox" class="input" name="wl_guest_date_x_Sat" onChange="return changeDate();"/>Sat
			  </td>
			</tr>
			<tr id="row_guest_2" style="display:none;">
			  <th><#WIFIGuestTime#></th>
			  <td>
				<input type="text" maxlength="2" class="input" size="2" name="wl_guest_time_x_starthour" onKeyPress="return is_number(this)"/>:
				<input type="text" maxlength="2" class="input" size="2" name="wl_guest_time_x_startmin" onKeyPress="return is_number(this)"/>-
				<input type="text" maxlength="2" class="input" size="2" name="wl_guest_time_x_endhour" onKeyPress="return is_number(this)"/>:
				<input type="text" maxlength="2" class="input" size="2" name="wl_guest_time_x_endmin" onKeyPress="return is_number(this)"/>
			  </td>
			</tr>
