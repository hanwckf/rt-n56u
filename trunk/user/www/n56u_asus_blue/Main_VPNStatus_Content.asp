...
<title>ASUS Wireless Router <#Web_Title#> - <#menu5_7_7#></title>
...
<input type="hidden" name="current_page" value="Main_VPNStatus_Content.asp">
        ...
        <tr>
          <td valign="top">
            <table width="90%" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3"  class="FormTitle">
              ...
              <tr>
                <td align="center">
			<textarea cols="63" rows="20" readonly="readonly" wrap=off style="font-family:'Courier New', Courier, mono; font-size:13px;"><% nvram_dump("vpns_list.log", "vpns_list.sh"); %></textarea>
		</td>
              </tr>
