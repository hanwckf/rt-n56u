                                ...
                                <table width="100%" align="center" cellpadding="4" cellspacing="0" class="table">
                                    <tr>
                                        ...
                                        <td style="border-top: 0 none;">
                                            <select name="rt_macmode" class="input"  onChange="return change_common(this, 'DeviceSecurity11a', 'rt_macmode')">
                                                <option class="content_input_fd" value="disabled" <% nvram_match_x("DeviceSecurity11a","rt_macmode", "disabled","selected"); %>><#CTL_Disabled#></option>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input class="btn btn-primary" style="margin-left: 5px; width: 110px;" type="submit" onclick="return markGroup(this, 'rt_ACLList', 32, ' Add ');" name="rt_ACLList2" value="<#CTL_add#>" size="12"/>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div style="float: left;">
                                                ...
                                                <input class="btn btn-danger" style="width: 110px;" type="submit" onClick="return markGroup(this, 'rt_ACLList', 32, ' Del ');" name="rt_ACLList" value="<#CTL_del#>" size="12">
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
