                                ...
                                <table width="100%" align="center" cellpadding="4" cellspacing="0" class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input class="btn btn-primary" style="margin-left: 5px; width: 110px;" type="submit" onclick="return markGroup(this, 'ACLList', 32, ' Add ');" name="ACLList2" value="<#CTL_add#>" size="12"/>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div style="float: left;">
                                                ...
                                                <input class="btn btn-danger" style="width: 110px;" type="submit" onClick="return markGroup(this, 'ACLList', 32, ' Del ');" name="ACLList" value="<#CTL_del#>" size="12">
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
