                            ...
                            <div class="row-fluid">
                                ...
                                <table width="100%" align="center" cellpadding="4" cellspacing="0" class="table">
                                    ...
                                    <tr>
                                        ...
                                        <th width="30%"><#LANHostConfig_ManualName_itemname#></th>
                                        <th width="20%">&nbsp;</th>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <input class="btn btn-primary span12" style="max-width: 219px" type="submit" onclick="return markGroup(this, 'ManualDHCPList', 32, ' Add ');" name="ManualDHCPList2" value="<#CTL_add#>" size="12" />
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <input class="btn btn-danger span12" style="max-width: 219px" type="submit" onclick="return markGroup(this, 'ManualDHCPList', 32, ' Del ');" name="ManualDHCPList" value="<#CTL_del#>" size="12" />
                                        </td>
                                    </tr>
