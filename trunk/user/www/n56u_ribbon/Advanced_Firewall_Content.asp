                        ...
                        <div class="round_bottom">
                            <div class="row-fluid">
                                ...
                                <table width="100%" cellpadding="4" cellspacing="0" class="table">
                                    ...
                                    <tr>
                                        <th width="20%"><a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this,18,3);"><#FirewallConfig_LanWanSrcIP_itemname#></a></th>
                                        ...
                                        <th width="20%"><a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this,18,3);"><#FirewallConfig_LanWanDstIP_itemname#></a></th>
                                    ...
                                    <tr>
                                        ...
                                        <td><input class="btn btn-primary span12" style="max-width: 110px;" type="submit" onclick="if(validForm()){return markGroup(this, 'LWFilterList', 32, ' Add ');}" name="LWFilterList" value="<#CTL_add#>"/></td>
                                    </tr>
                                    <tr>
                                        <td colspan="5">
                                        ...
                                        <td>
                                            <input class="btn btn-danger span12" style="max-width: 110px;" type="submit" onclick="return markGroup(this, 'LWFilterList', 32, ' Del ');" name="LWFilterList2" value="<#CTL_del#>">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="6">
