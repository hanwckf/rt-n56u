...
function showGWStaticList(){
	...
	if(GWStaticList.length == 0)
		...
		for(var i = 0; i < GWStaticList.length; i++){
            code +='<tr id="row' + i + '">';
            code +='<td width="20%">' + GWStaticList[i][0] + '</td>';	//IP
            code +='<td width="20%">' + GWStaticList[i][1] + '</td>';	//Mask
            code +='<td width="20%">' + GWStaticList[i][2] + '</td>';	//Gateway
            code +='<td width="10%" style="padding-left: 13px;">' + GWStaticList[i][3] + '</td>';	//Metric
            code +='<td width="10%" style="padding-left: 13px;">' + GWStaticList[i][4] + '</td>';	//Interface
            code +='<td width="20%" style="padding-left: 13px;" ><input type="checkbox" name="GWStatic_s" value="' + i + '" id="check' + i + '"></td>';
            code +='</tr>';
            ...
            if(GWStaticList.length > 0)
            {
                ...
                code += '<td style="padding-left: 13px;" ><input class="btn btn-danger span6" type="submit" style="max-width: 219px" onclick="markGroup(this, \'GWStatic\', 32,\' Del \');" value="<#CTL_del#>"/></td>';
                code += '</tr>'
            }
                            ...
                            <div class="row-fluid">
                                ...
                                <table width="100%" align="center" cellpadding="4" cellspacing="0" class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input class="btn btn-primary span6" style="max-width: 219px" type="submit" onClick="return GWStatic_markGroup(this, 'GWStatic', 32, ' Add ');" name="GWStatic" value="<#CTL_add#>">
                                        </td>
                                    </tr>
                                    <tr>
