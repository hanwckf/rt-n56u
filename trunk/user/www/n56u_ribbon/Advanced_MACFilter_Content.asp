                                ...
                                <table width="100%" cellpadding="4" cellspacing="0" class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input class="btn btn-primary" style="margin-left: 5px; width: 110px;" type="submit" onclick="markGroup(this, 'MFList', 32, ' Add ');" name="MFList" value="<#CTL_add#>" size="12"/>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input class="btn btn-danger" style="width: 110px; margin-left: 5px;" type="submit" onClick="return markGroup(this, 'MFList', 32, ' Del ');" name="MFList" value="<#CTL_del#>" size="12">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
