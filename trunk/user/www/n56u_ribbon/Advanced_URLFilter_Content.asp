                            ...
                            <div class="row-fluid">
                                ...
                                <table width="100%" cellpadding="4" cellspacing="0" class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="controls">
                                                <label class="checkbox inline"><input type="checkbox" name="url_date_x_Mon" class="input" onChange="return changeDate();">Mon</label>
                                                <label class="checkbox inline"><input type="checkbox" name="url_date_x_Tue" class="input" onChange="return changeDate();">Tue</label>
                                                <label class="checkbox inline"><input type="checkbox" name="url_date_x_Wed" class="input" onChange="return changeDate();">Wed</label>
                                                <label class="checkbox inline"><input type="checkbox" name="url_date_x_Thu" class="input" onChange="return changeDate();">Thu</label>
                                                <label class="checkbox inline"><input type="checkbox" name="url_date_x_Fri" class="input" onChange="return changeDate();">Fri</label>
                                                <label class="checkbox inline"><input type="checkbox" name="url_date_x_Sat" class="input" onChange="return changeDate();">Sat</label>
                                                <label class="checkbox inline"><input type="checkbox" name="url_date_x_Sun" class="input" onChange="return changeDate();">Sun</label>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td style="padding: 8px;">
                                            ...
                                            <input class="btn btn-primary" style="margin-left: 5px; width: 110px;" type="submit" onClick="if(validForm()){return markGroup(this, 'UrlList', 128, ' Add ');}" name="UrlList" value="<#CTL_add#>" size="12">
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>&nbsp;</th>
                                        <td style="padding: 8px;">
                                            ...
                                            <input class="btn btn-danger" style="margin-left: 5px; width: 110px;" type="submit" onClick="return markGroup(this, 'UrlList', 128, ' Del ');" name="UrlList" value="<#CTL_del#>" size="12">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
