                                ...
                                <table width="100%" align="center" cellpadding="4" cellspacing="0" class="table">
                                    <tr id="row_wds_apc" style="display:none;">
                                        ...
                                        <td>
                                            ...
                                            <input class="btn btn-primary" style="margin-left: 5px; width: 110px;" type="submit" onClick="return markGroup(this, 'RBRList', 2, ' Add ');" name="RBRList" value="<#CTL_add#>" size="12">
