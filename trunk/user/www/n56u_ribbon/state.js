...
tabtitle[3] = new Array("", "<#menu5_3_1#>", "<#menu5_3_3#>", "<#menu5_3_4#>", "<#menu5_3_5#>", "<#menu5_3_6#>", "<#NAT_passthrough_itemname#>");
...
function show_menu(L1, L2, L3){
	tabtitle[5].splice(3,1);//Keyword Filter
	tablink[5].splice(3,1);//Keyword Filter
