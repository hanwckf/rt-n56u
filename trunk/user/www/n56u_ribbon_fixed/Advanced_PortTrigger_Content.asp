...
function showTriggerList(){
	...
	if(TriggerList.length == 0)
		code +='<tr><td colspan="6" style="text-align: center;"><div class="alert alert-info"><#IPConnection_VSList_Norule#></div></td></tr>';
            ...
            code +='<td width="10%">'+ TriggerList[i][1] +'</td>';		//local IP
            code +='<td width="25%">'+ TriggerList[i][2] +'&nbsp;</td>';	//local port
            code +='<td width="10%">'+ TriggerList[i][3] +'</td>';		//proto
                                ...
                                <div class="row-fluid">
                                    ...
                                    <table width="100%" cellpadding="4" cellspacing="0" class="table">
                                            ...
                                            <td colspan="3">
                                                <div class="main_itoggle">
                                                    <div id="autofw_enable_x_on_of">
                                                        <input type="checkbox" id="autofw_enable_x_fake" <% nvram_match_x("", "autofw_enable_x", "1", "value=1 checked"); %><% nvram_match_x("", "autofw_enable_x", "0", "value=0"); %>>
                                                    </div>
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <th width="25%"><#IPConnection_autofwOutPort_itemname#></th>
                                            <th width="10%"><#IPConnection_autofwOutProto_itemname#></th>
                                            <th width="25%"><#IPConnection_autofwInPort_itemname#></th>
                                            <th width="10%"><#IPConnection_autofwInProto_itemname#></th>
                                            <th width="5%">&nbsp;</th>
                                        </tr>
                                        <tr>
                                            <td>
                                        ...
                                        <tr>
                                            <td colspan="6" style="border: 0 none;padding: 0px;">
