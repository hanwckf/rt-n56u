...
function initial(){
	...
	}else if(document.form.rt_gmode.value == "2" || document.form.rt_gmode.value == "5"){	// b/g/n, g/n
                                ...
                                <div class="row-fluid">
                                    ...
                                    <table width="100%" align="center" cellpadding="4" cellspacing="0" class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="controls">
                                                    <label class="checkbox inline"><input type="checkbox" class="input" name="rt_radio_date_x_Mon" onChange="return changeDate();"/>Mon</label>
                                                    <label class="checkbox inline"><input type="checkbox" class="input" name="rt_radio_date_x_Tue" onChange="return changeDate();"/>Tue</label>
                                                    <label class="checkbox inline"><input type="checkbox" class="input" name="rt_radio_date_x_Wed" onChange="return changeDate();"/>Wed</label>
                                                    <label class="checkbox inline"><input type="checkbox" class="input" name="rt_radio_date_x_Thu" onChange="return changeDate();"/>Thu</label>
                                                    <label class="checkbox inline"><input type="checkbox" class="input" name="rt_radio_date_x_Fri" onChange="return changeDate();"/>Fri</label>
                                                    <label class="checkbox inline"><input type="checkbox" class="input" name="rt_radio_date_x_Sat" onChange="return changeDate();"/>Sat</label>
                                                    <label class="checkbox inline"><input type="checkbox" class="input" name="rt_radio_date_x_Sun" onChange="return changeDate();"/>Sun</label>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" maxlength="2" style="width: 25px;" size="2" name="rt_radio_time_x_starthour" onKeyPress="return is_number(this)">:
                                                <input type="text" maxlength="2" style="width: 25px;" size="2" name="rt_radio_time_x_startmin" onKeyPress="return is_number(this)">&nbsp;-&nbsp;
                                                <input type="text" maxlength="2" style="width: 25px;" size="2" name="rt_radio_time_x_endhour" onKeyPress="return is_number(this)">:
                                                <input type="text" maxlength="2" style="width: 25px;" size="2" name="rt_radio_time_x_endmin" onKeyPress="return is_number(this)">
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr id="rt_rate">
                                            ...
                                            <td>
                                                <select name="rt_rate" class="input" onChange="return change_common(this, 'WLANConfig11b', 'rt_rate')">
                                                    ...
                                                    <option value="12000000" <% nvram_smatch_x("WLANConfig11b","rt_rate", "12000000","selected"); %>>12</option>
