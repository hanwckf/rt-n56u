                ...
                <div class="row-fluid">
                    <div class="span12">
                        <div class="box well grad_colour_dark_blue">
                            <h2 class="box_head round_top"><#t1Wireless#> - <#t2RADIUS#> (5GHz)</h2>
                                ...
                                <div class="row-fluid">
                                    ...
                                    <table width="100%" align="center" cellpadding="4" cellspacing="0" class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" maxlength="5" class="input" size="5" name="wl_radius_port" value="<% nvram_get_x("WLANAuthentication11a","wl_radius_port"); %>" onkeypress="return is_number(this)" onblur="return validate_portrange(this, '')"/>
                                            </td>
                                        </tr>
                                        <tr>
