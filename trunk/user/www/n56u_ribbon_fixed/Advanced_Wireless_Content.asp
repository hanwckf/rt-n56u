                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="wl_auth_mode" class="input" onChange="return change_common_wl(this, 'WLANConfig11a', 'wl_auth_mode');">
                                                    ...
                                                    <option value="wpa" <% nvram_double_match_x("WLANConfig11a", "wl_auth_mode", "wpa", "WLANConfig11a", "wl_wpa_mode", "3", "selected"); %>>WPA-Enterprise (Radius)</option>
                                                    <option value="wpa2" <% nvram_match_x("WLANConfig11a", "wl_auth_mode", "wpa2", "selected"); %>>WPA2-Enterprise (Radius)</option>
                                                    <option value="wpa" <% nvram_double_match_x("WLANConfig11a", "wl_auth_mode", "wpa", "WLANConfig11a", "wl_wpa_mode", "4", "selected"); %>>WPA-Auto-Enterprise (Radius)</option>
