                                    ...
                                    <table width="100%" align="center" cellpadding="4" cellspacing="0" class="table" id="WLgeneral">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div style="position: absolute; margin-left: -10000px;">
                                                    <input type="radio" value="1" id="wl_closed_1" name="wl_closed" onClick="return change_common_radio(this, 'WLANConfig11b', 'wl_closed', '1')" <% nvram_match_x("WLANConfig11b", "wl_closed", "1", "checked"); %> /><#checkbox_Yes#>
                                                    <input type="radio" value="0" id="wl_closed_0" name="wl_closed" onClick="return change_common_radio(this, 'WLANConfig11b', 'wl_closed', '0')" <% nvram_match_x("WLANConfig11b", "wl_closed", "0", "checked"); %> /><#checkbox_No#>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
