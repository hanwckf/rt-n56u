...
<title>ASUS Wireless Router <#Web_Title#> - <#menu5_7_8#></title>
                                    ...
                                    <table width="100%" cellpadding="4" cellspacing="0" class="table">
                                        <tr>
                                            <td style="border-top: 0 none; padding-bottom: 0px;">
                                                <textarea style="font-family:'Courier New', Courier, mono; font-size:13px;" class="span12" rows="23" readonly="readonly" wrap="off" ><% nvram_dump("conntrack.log","conntrack.sh"); %></textarea>
                                            </td>
                                        </tr>
                                        <tr>
