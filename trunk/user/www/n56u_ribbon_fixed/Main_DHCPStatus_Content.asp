...
<body onload="show_banner(1); show_menu(5,9,2); show_footer();">
<div class="wrapper">
                                    ...
                                    <table width="100%" cellpadding="4" cellspacing="0" class="table">
                                        <tr>
                                            <td style="border-top: 0 none;">
                                                <textarea cols="63" rows="20" class="span12" style="font-family:'Courier New', Courier, mono; font-size:13px;" readonly="readonly" wrap=off><% nvram_dump("leases.log", "leases.sh"); %></textarea>
