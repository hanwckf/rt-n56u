...
<body onload="show_banner(1); show_menu(5,9,4); show_footer();">
                                    ...
                                    <table width="100%" cellpadding="4" cellspacing="0" class="table">
                                        <tr>
                                            <td style="border-top: 0 none;">
                                                <textarea style="font-family:'Courier New', Courier, mono; font-size:13px;" class="span12" rows="20" readonly="readonly" wrap=off ><% nvram_dump("iptable.log","iptable.sh"); %></textarea>
                                            </td>
                                        </tr>
                                        <tr>
