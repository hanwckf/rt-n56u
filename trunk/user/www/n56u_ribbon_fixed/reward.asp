                    ...
                    <div class="round_bottom">
                        ...
                        <div>
                            <ul class="nav nav-tabs" style="margin-bottom: 10px;">
                                <li class="active">
                                 <a id="tab_vpns_cfg" href="#cfg"><如果感到固件还可以，并且想赞助一下苦逼的技术人员，可以用支付宝扫一下，一个是支付宝收款，一个是消费红包。谢谢！-我也不想为五斗米折腰啊！></a>
                                </li>
                                <li>
                        ...
                        <div id="wnd_vpns_cfg">
                            <div class="alert alert-info" style="margin: 10px;">
                                <table class="auto-style1">
                                    <tr>
                                        <td><img src="/bootstrap/img/zfb.jpg"  width="278" height="300" alt="支付宝" /></td>
                                        <td><img src="/bootstrap/img/zfbhb.png"   width="278" height="300"  alt="支付宝红包" /></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        <td>&nbsp;</td>
...
                                            <option value="14" <% nvram_match_x("", "vpns_ov_ciph", "14","selected"); %>>[AES-256-GCM] AES-GCM, 256 bit</option>
                            ...
                            <table class="table">
                                <tr>
                                    <td style="border: 0 none; padding: 0px;"><center></center></td>
                                </tr>
                            </table>
                        </div>
