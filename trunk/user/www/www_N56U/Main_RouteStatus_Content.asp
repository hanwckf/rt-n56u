            ...
            <table width="98%" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3"  class="FormTitle">
              ...
              <tr>
                <td colspan="2" align="center">
                  <textarea style="width:98%; font-family:'Courier New', Courier, mono; font-size:13px;" cols="63" rows="20" readonly="readonly" wrap=off><% nvram_dump("route.log","route.sh"); %></textarea><!--==magic 2008.11 del name ,if there are name, when the form was sent, the textarea also will be sent==-->
				</td>
              </tr>
			  <tr align="right">
			  <td>
